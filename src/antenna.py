...
class Housing:
    ...
    # with radius base_r.
    @staticmethod
    def __element_housing_profile_xy(
    ...
    @staticmethod
    def __element_housing_profile_yz(
    ...
    def build(
        ...
        hmid = 0
        s1 = Pos(0, 0, hmid-element_housing_r) * Housing.__element_housing_profile_xy(
            element_housing_width, element_housing_r, 
            element_height,
            base_r1)
        s2 = Pos(0, 0, hmid+element_housing_r) * Housing.__element_housing_profile_xy(
            element_housing_width, element_housing_r, 
            element_height,
            base_r2)
        l = loft([s1, s2])
        ...
        l2 = extrude(to_extrude = 
                Pos(-element_housing_width/2, 0) * 
                    Housing.__element_housing_profile_yz(
...
#    d = 2 * r
    ...
    if reversed:
        (r1, r2) = (r2, r1)
    el_outer = Location((pos, 0)) * mirror(Housing.build(
